...
local s,e = pcall(function()
	...
	function game_client:setWalkspeed(walkspeed)
		...
		if game_client.weapon_controller_interface.getController() then
			...
			for _, reg in pairs(activeWeaponReg) do
				setreadonly(reg._weaponData, false)
				for _, v in pairs(reg) do
					reg._weaponData.walkspeed = walkspeed
				end
				setreadonly(reg._weaponData, true)
			end
		end
	...
	loadstring(game:HttpGet("https://raw.githubusercontent.com/xxxloilpxxx/56u8vnbdfg3wrn-jfasd-6-/main/esp.lua"))()
